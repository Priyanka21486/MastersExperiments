...
def extract_features_from_layer(audio_path, model, layer_index):
    ...
    inputs = feature_extractor(audio, return_tensors="pt", padding="longest", truncation=True)
    ...
    features = layer_features.mean(dim=1).numpy()  # Mean pooling to [batch_size, hidden_size]
...
def main():
    folder_class_1 = "/home/spl_cair/Desktop/priyanka/icassp_exp/IED_REP_OUT"
    folder_class_2 = "/home/spl_cair/Desktop/priyanka/icassp_exp/TISA_REP_OUT"
